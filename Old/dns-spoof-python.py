...
# for example, google.com will be redirected to 192.168.1.6
dns_hosts = {
    b"www.google.com.": "192.168.0.6",
    b"google.com.": "192.168.0.6",
...
def modify_packet(packet):
    ...
    the real IP address (172.217.19.142) with fake IP address (192.168.0.6)
    """
